          ...
          <div class="popup-right">
            ...
            <div id="popupFormView">
              ...
              <div class="popup-contact-links">
                ...
                <a href="mailto:hei@mediegruppen.no" class="popup-contact-link"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>hei@mediegruppen.no</a>
              </div>
            </div>
