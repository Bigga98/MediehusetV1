...
(function () {
  ...
  logo.innerHTML = `<svg class="mg-logo-svg" viewBox="0 0 398 63" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Mediegruppen">
    <path d="M0 9V46L5.5 46V17C5.5 17 17.8396 28.8214 20.5 46H26L41.5 20V46L47 46V9H41.5L23.5 38C18.6226 20.381 5.5 9 5.5 9H0Z" fill="#292929"/>
    ...
    <path class="mg-bar mg-bar-1" d="M343 18H386.5L383.38 24.5H343V18Z" fill="#292929"/>
    <path class="mg-bar mg-bar-2" d="M343 28.4999H398L396.027 31.7499L394.055 34.9999H343V28.4999Z" fill="#292929"/>
    <path class="mg-bar mg-bar-3" d="M343 38.9999H386.5L383.38 45.4999H343V38.9999Z" fill="#292929"/>
  </svg>`;
